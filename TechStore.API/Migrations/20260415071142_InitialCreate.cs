    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 15, 7, 11, 40, 779, DateTimeKind.Utc).AddTicks(1110), "Latest smartphones and accessories", null, true, "Smartphones" },
                    { 2, new DateTime(2026, 4, 15, 7, 11, 40, 779, DateTimeKind.Utc).AddTicks(1113), "Tablets and e-readers", null, true, "Tablets" },
                    { 3, new DateTime(2026, 4, 15, 7, 11, 40, 779, DateTimeKind.Utc).AddTicks(1116), "Wearable technology", null, true, "Smart Watches" },
                    { 4, new DateTime(2026, 4, 15, 7, 11, 40, 779, DateTimeKind.Utc).AddTicks(1119), "Laptops and ultrabooks", null, true, "Laptops" },
                    { 5, new DateTime(2026, 4, 15, 7, 11, 40, 779, DateTimeKind.Utc).AddTicks(1121), "Cases, chargers, and more", null, true, "Accessories" }
                });
